...
<script type="text/javascript">
	...
	function getSale() {  
		...
		$.ajax({
            ...
            success: function(res, textStatus, jqXHR){
				console.log(res);
                $('#input-number').val(res.data.number)
                $('#input-store-id').val(res.data.store_id).trigger('change')
                $('#input-cash-register-id').val(res.data.cash_register_id).trigger('change')
                $('#input-customer-id').val(res.data.customer_id).trigger('change')
                $('#input-discount-percentage').val(res.data.discount_percentage)
                $('#input-discount-value').val(res.data.discount_value)
                $('#input-total').val(res.data.total)
                $('#input-note').val(res.data.note)
                $('#input-customer-pay').val(res.data.customer_pay)
                $('#input-customer-charge').val(res.data.customer_charge)
            },
            error: function(jqXHR, textStatus, errorThrown){
