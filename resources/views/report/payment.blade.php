...
<script type="text/javascript">
        ...
        $("#main-table").DataTable({
            ...
            "ajax":{
                ...
                "data":function(d) { 
				  ...
				  d.created_by = $('#input-user-id').val()
                },
            },
            "columns": [
                ...
                { data: 'created_at', name: 'created_at', className: 'text-center border-b', render : data => moment(data).format('DD MMM YYYY hh:mm:ss') },
	...
	$(document).on('click', '#pdf-button', function (e) {  
		...
		const data = {
			...
			'created_by' : parseInt($('#input-user-id').val()),
		}
		$.ajax({
            type: 'POST',
            url: API_URL+"/api/payment_pdf",
            headers: { 'Authorization': 'Bearer '+TOKEN },
