	...
	<table class="table table-report table-report--bordered display datatable w-full" id="main-table">
		<thead>
			<tr>
				...
				<th class="border-b-2 text-center whitespace-no-wrap">Sales Name</th>
				<th class="border-b-2 text-center whitespace-no-wrap">Sales Phone</th>
				<th class="border-b-2 text-center whitespace-no-wrap">Term Of Payment</th>
